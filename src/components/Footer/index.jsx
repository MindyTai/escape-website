...
const Footer = () => (
      <footer className="p-4" id="news">
        ...
        <div className="row">
          ...
          新竹展時間：4/30(Tue.)
          <br/>
          新竹展地點：<a className="map" href="https://www.google.com/maps/place/%E8%B2%B3%E8%B2%B3%E6%9F%92+lab227/@24.7899211,120.9987856,15z/data=!4m2!3m1!1s0x0:0x12839cd95251eadb?sa=X&ved=2ahUKEwidlK6ZneXhAhUGxLwKHQB2AYgQ_BIwCnoECA8QCA" target='_blank'rel='noreferrer noopener'>貳貳柒 Lab 227</a>
          <br/>
